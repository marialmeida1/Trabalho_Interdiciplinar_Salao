        ...
        if (mysqli_num_rows($consulta) > 0) { // entra
            ...
            while ($row_func2 = mysqli_fetch_assoc($resultadoE)) {
                ...
                if ($row_func2['endPes_id'] == $newId) {
                    ...
                    echo "Rua: " . $row_func2['endRua'] . "  |  Bairro: " . $row_func2['endBairro'] . "  |  Cidade: " . $row_func2['endCidade'] . "|  Numero: " . $row_func2['endNro'] . "<br>";
                    ...
                    while ($row_func3 = mysqli_fetch_assoc($resultadoT)) {
                        ...
                        if ($row_func3['telPes_id'] == $newId) {
                            ...
                            echo "<a href='../BancoDeDados/formDoEditar.php?id= " . $row_func['pesId'] . "' id='link'>Editar</a><br><hr>";
                            break;
                        } else {
                        }
                    }
