        ...
        if (mysqli_num_rows($consulta) > 0) { // entra
            ...
            while ($row_func2 = mysqli_fetch_assoc($resultadoE)) {
                ...
                if ($row_func2['pessoa_id'] == $newId) {
                    ...
                    echo "Rua: " . $row_func2['rua'] . "  |  Bairro: " . $row_func2['bairro'] . "  |  Cidade: " . $row_func2['cidade'] . "|  Numero: " . $row_func2['nro'] . "<br>";
                    ...
                    while ($row_func3 = mysqli_fetch_assoc($resultadoT)) {
                        ...
                        if ($row_func3['pessoa_id'] == $newId) {
                            ...
                            echo "<a href='../BancoDeDados/formDoEditar.php?id= " . $row_func['id'] . "' id='link'>Editar</a><br><hr>";
                            break;
                        } else {
                        }
                    }
