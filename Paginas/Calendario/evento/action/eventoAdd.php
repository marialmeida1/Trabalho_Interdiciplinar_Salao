<?php
	...
	if (isset($_POST['titulo']) && isset($_POST['cor']) && isset($_POST['inicio']) && isset($_POST['termino']) ){
		...
		$sql = "INSERT INTO evento(fk_id_usuario, titulo, descricao, inicio, termino, cor) values ('$id_usuario', '$titulo', '$cor', '$inicio', '$termino')";
		...
		$sql2 = "INSERT INTO convite(fk_id_destinatario, fk_id_remetente, fk_id_evento, status) values ('$convidado', '$id_usuario', '$id_evento', null)";
