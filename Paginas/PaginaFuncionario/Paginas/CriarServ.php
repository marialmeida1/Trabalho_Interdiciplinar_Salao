                        ...
                        <ul class="sidebar-body-menu">
                            <li>
                                <a class="show-cat-btn" href="##">
                                    <span class="icon user-3" aria-hidden="true"></span>Funcionarios
                                ...
                                <ul class="cat-sub-menu">
                                    <li>
                                        <a href="CriarFunc.php">Modificar</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                    ...
                    <div class="row stat-cards">
                        <div class="col-md-6 col-xl-4">
                            <article class="stat-cards-item">
                                ...
                                <div class="stat-cards-info">
                                    <p class="stat-cards-info__num">Adicionar Serviço</p>
                                    <hr>
                        ...
                        <div class="col-md-6 col-xl-4">
                            <article class="stat-cards-item">
                                ...
                                <div class="stat-cards-info">
                                    <p class="stat-cards-info__num">Editar Serviço</p>
                                    <hr>
                        ...
                        <div class="col-md-6 col-xl-4">
                            <article class="stat-cards-item">
                                ...
                                <div class="stat-cards-info">
                                    <p class="stat-cards-info__num">Deletar Serviço</p>
                                    <hr>
                        ...
                        <div class="col-lg-12">
                            <article class="stat-cards-item" id="tamanho">
                                <div class="stat-cards-info" id="tamanho">
                                    ...
                                    <h5>Listagem de Serviços</h2>
                                        <hr>
                                        <div class="col-lg-16">
                                            <article class="stat-cards-item ">
                                                <div class="stat-cards-info" id="tamanho">

                                                    <?php include("../BancoDeDados/mostrarSer.php"); ?>
                                                </div>
                                            </article>
                                        </div>
                                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="../BancoDeDados/cadastroSer.php" method="post">

                        <div class="form-outline mb-4">
                            <input type="text" id="nome" class="form-control textModal" placeholder="Nome do Serviço" name="nome" />
                        </div>

                        <div class="form-outline mb-4">
                            <input type="text" id="email" class="form-control textModal" placeholder="Descrição do Serviço" name="desc" />
                        </div>

                        <div class="form-outline mb-4">
                            <input type="number" id="senha" class="form-control textModal" placeholder="Valor do Serviço" name="valor" />
                        </div>
    ...
    <div class="modal fade" id="modalAlt" abindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <?php include("../BancoDeDados/editarSer.php") ?>
        ...
        <div class="modal fade" id="modalDelet" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Deletar Serviços</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Fechar">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        ...
                        <?php include("../BancoDeDados/deletarSer.php") ?>
